document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (isRequired && !VALIDATORS.required(field.type === 'checkbox' ? value : value)) {
      ...
      if ((fieldType === 'email' || field.dataset.validate === 'email') && value.trim() !== '') {
      ...
      if ((fieldType === 'tel' || field.dataset.validate === 'tel') && value.trim() !== '') {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '70211eec-1fe4-469a-bf33-9891dd7a3035',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '70211eec-1fe4-469a-bf33-9891dd7a3035';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '70211eec-1fe4-469a-bf33-9891dd7a3035';
